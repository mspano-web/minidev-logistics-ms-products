...
# MiniDev-Logistic:  ms-products

La presente iniciativa contiene el codigo de un mini desarrollo de software BackEnd.
En particular, este proyecto contiene el modulo denominado ms-products.
...
In particular, this project contains the module called ms-products.
